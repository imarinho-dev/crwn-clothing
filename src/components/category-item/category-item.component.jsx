...
const CategoryItem = ({ category }) => {
	...
	return (
		<div className="min-w-[30%] h-60 flex-auto flex justify-center items-center border border-solid border-black mx-2 mb-4 overflow-hidden hover:cursor-pointer group">
			<div
			...
			<div className="h-24 px-6 flex flex-col items-center justify-center border border-solid border-black group-hover:border-white bg-white group-hover:bg-black opacity-70 absolute">
				<h2 className="font-bold mx-2 text-xl text-[#4a4a4a] group-hover:text-white">
					{title}
				</h2>
